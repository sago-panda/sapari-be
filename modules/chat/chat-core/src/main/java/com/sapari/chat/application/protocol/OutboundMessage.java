...
public record OutboundMessage(
        String type,             // NORMAL | NOTICE | SYSTEM | KICK | ROOM_INFO | RATE_LIMIT | ERROR
        String code,             // SYSTEM: KICKED|ROOM_ENDED|BANNED / ERROR: VALIDATION|PERMISSION|KICKED|NOT_ACTIVE|INTERNAL (그 외 null)
        String id,               // NORMAL/NOTICE: MongoDB ObjectId (그 외 null)
        ...
        Instant createdAt,       // NORMAL/NOTICE (그 외 null)
