...
public interface ChatKickRepository {
     ...
     * 그게 진짜인지 확인할 수단이 chat에는 없다. 즉시 지우면 잘못된 신호 하나가 그 방의 모더레이션 기록을
     * 되돌릴 수 없게 만든다 — 강퇴됐던 사람이 전부 그 자리에서 돌아온다. 만료로 두면 같은 실수가
     * "유예 시간 안에 알아채면 복구 가능한" 것이 된다. 누수를 막는다는 목적은 그대로 달성된다.
     *
